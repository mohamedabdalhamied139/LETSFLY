...
class SoundEngine:
    ...
    GAME_EVENT_CUES = {
        ...
        "DOMINO": {
            "GAME_STARTED": ("DOMINO_SHUFFLE", "DOMINO_PRE_ROUND", "DOMINO_ROUND_START"),
            "ROUND_START": ("DOMINO_SHUFFLE", "DOMINO_PRE_ROUND", "DOMINO_ROUND_START"),
            "ROUND_STARTED": ("DOMINO_SHUFFLE", "DOMINO_PRE_ROUND", "DOMINO_ROUND_START"),
